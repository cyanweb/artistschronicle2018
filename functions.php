...
function twentysixteen_setup() {
	...
	register_nav_menus( array(
		...
		'footermenu'  => __( 'Footer Menu', 'twentysixteen' ),
	) );
...
function twentysixteen_widgets_init() {
	register_sidebar( array(
		'name'          => __( 'Front Page Sidebar', 'twentysixteen' ),
		'id'            => 'sidebar-1',
		'description'   => __( 'Add widgets here to appear in your front page sidebar.', 'twentysixteen' ),
	...
	register_sidebar( array(
		'name'          => __( 'Body Page Sidebar', 'twentysixteen' ),
		'id'            => 'sidebar-2',
		'description'   => __( 'Add widgets here to appear in your front page sidebar.', 'twentysixteen' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
